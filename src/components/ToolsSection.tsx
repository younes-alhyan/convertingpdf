...
const tools = [
  {
    icon: Combine,
    title: "Merge PDF",
    description: "Combine multiple PDF files into a single document easily and quickly.",
    color: "text-primary"
  },
  {
    icon: Scissors,
    title: "Split PDF",
    description: "Separate pages from your PDF or split one file into multiple documents.",
    color: "text-accent"
  },
  {
    icon: Minimize2,
  ...
  },
  {
    icon: FileText,
    title: "PDF to Word",
    description: "Convert PDF documents to editable Word files with precision formatting.",
    color: "text-primary"
  },
  {
    icon: Image,
  ...
  },
  {
    icon: Edit3,
    title: "Edit PDF",
    description: "Add text, images, signatures, and annotations to your PDF documents.",
    color: "text-success"
  }
];
      ...
      <div className="container px-4">
        <div className="max-w-3xl mx-auto text-center space-y-4 mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground">
            Everything you need to work with PDF files, powered by advanced technology
          </p>
        </div>
            ...
            >
              <CardHeader className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className={`p-3 rounded-lg bg-secondary ${tool.color} transition-colors group-hover:scale-110 duration-300`}>
